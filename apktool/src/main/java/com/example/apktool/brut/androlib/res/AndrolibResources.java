 ...
 */
package com.example.apktool.brut.androlib.res;

import com.example.apktool.brut.androlib.AndrolibException;
import com.example.apktool.brut.androlib.ApkOptions;
import com.example.apktool.brut.androlib.err.CantFindFrameworkResException;
import com.example.apktool.brut.androlib.meta.MetaInfo;
import com.example.apktool.brut.androlib.meta.PackageInfo;
import com.example.apktool.brut.androlib.meta.VersionInfo;
import com.example.apktool.brut.androlib.res.data.*;
import com.example.apktool.brut.androlib.res.decoder.*;
import com.example.apktool.brut.androlib.res.decoder.ARSCDecoder.ARSCData;
import com.example.apktool.brut.androlib.res.decoder.ARSCDecoder.FlagsOffset;
import com.example.apktool.brut.directory.*;
import com.example.apktool.brut.androlib.res.util.ExtMXSerializer;
import com.example.apktool.brut.androlib.res.util.ExtXmlSerializer;
import com.example.apktool.brut.androlib.res.xml.ResValuesXmlSerializable;
import com.example.apktool.brut.androlib.res.xml.ResXmlPatcher;
import com.example.apktool.brut.common.BrutException;
import com.example.apktool.brut.util.*;
...
//        decoders.setDecoder("9patch", new Res9patchStreamDecoder()); // not supported in android
    ...
    public File getFrameworkDir() throws AndrolibException {
        ...
        if (apkOptions.frameworkFolderLocation != null) {
            ...
            // TODO probogate Activity to this location
