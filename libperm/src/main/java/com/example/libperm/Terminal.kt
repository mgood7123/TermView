...
import com.example.libutils.StackTraceInfo
import com.example.libutils.extensions.ThreadWaitForCompletion
import com.example.libutils.extensions.pxToSp
import com.example.libutils.extensions.isLessThan
...
class Terminal {
    ...
    fun termView(UI: UiThread, context: Context): Zoomable {
